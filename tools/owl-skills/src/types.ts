...
export interface ParsedSource {
  type: "github" | "gitlab" | "git" | "local" | "well-known" | "hub-name";
  url: string;
  subpath?: string;
  localPath?: string;
  ref?: string;
  ...
  skillFilter?: string;
  /** Hub name for hub-name type (e.g., "hello", "code-review") */
  name?: string;
}
...
/** Configuration for owl-skills CLI, stored at ~/.owl-skills/config.json */
