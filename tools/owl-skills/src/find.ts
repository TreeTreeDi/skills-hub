...
${DIM}  1) npx dt-skills find [query]${RESET}
${DIM}  2) npx dt-skills add <owner/repo@skill>${RESET}`;
  ...
  if (query) {
    ...
    console.log(`${DIM}Install with${RESET} npx dt-skills add <owner/repo@skill>`);
    console.log();
